...
public class FGContractTemplate
{
    ...
    public List<FGContract.ConstraintAndReward> PossibleConstraints;
    ...
    public List<FGContract.ReputationReward> RepRewards;
    public List<FGContract.ReputationRequirement> ReputationRequirements;
