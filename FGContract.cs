...
public class FGContract
{
    ...
    public string HiringFactionID { get; set; } // case-sensitive
    ...
    private List<KeyValuePair<string, List<SosigEnemyID>>> TargetIDs = new List<KeyValuePair<string, List<SosigEnemyID>>>(); // default key "targets"
    private List<KeyValuePair<string, List<SosigEnemyID>>> GuardIDs = new List<KeyValuePair<string, List<SosigEnemyID>>>(); // default key "guards"
    private List<KeyValuePair<string, List<SosigEnemyID>>> ExtrasIDs = new List<KeyValuePair<string, List<SosigEnemyID>>>(); // default key "extras"
    ...
    private List<KeyValuePair<string, string>> Faction_Target = new List<KeyValuePair<string, string>>();  // Add list of factions for Target
    private List<KeyValuePair<string, string>> Faction_Guards = new List<KeyValuePair<string, string>>();   // Add list of factions for Guards
    private List<KeyValuePair<string, string>> Faction_Extras = new List<KeyValuePair<string, string>>();   // Add list of factions for Extras
    ...
    // Default is "default_enemy". Can't be empty. Otherwise it's the X of the X.json
    // file that should be loaded (Game-planner Lite)
